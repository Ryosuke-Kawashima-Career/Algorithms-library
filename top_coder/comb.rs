...
pub trait Combination<I: Iterator> {
    fn combinations(self, n: usize) -> Combinations<I>;
}

// IntoIterator を実装するものに対して Combination を実装する
impl <I: Iterator> Combination<I> for I {
    fn combinations(self, n: usize) -> Combinations<I>
    {
        let mut indices: Vec<usize> = Vec::with_capacity(n);
        for i in 0..n {
        ...
        let mut pool: LazyBuffer<I> = LazyBuffer::new(self);
...
impl<I> std::ops::Index<usize> for LazyBuffer<I>
where
    I: Iterator,
    I::Item: Sized,
{
