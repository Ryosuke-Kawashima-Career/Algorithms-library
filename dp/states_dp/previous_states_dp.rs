...
// abc464d
// Q. You are given the weather of each day and the cost to change weathers of days and the reward of traveling between days. find the maximum happiness.
// A. DP for the two states (rainy and sunny as of now)
fn main() {
    input! {t: usize}
    for _case in 0..t {
